...
### Reboot-to-Sync Logic
To maintain stability and comply with HomeKit/RainMaker registration constraints:
1. **Learn**: User teaches the hub a new IR command via the Web Dashboard.
